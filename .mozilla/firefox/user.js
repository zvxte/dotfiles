 ...
 /* DISABLE PROXY AND USE SYSTEM'S DNS resolver */
...
/* do not confirm quitting with ctrl + q */
user_pref("browser.warnOnQuitShortcut", false);
/* do not allow websites to use their own fonts */
user_pref("browser.display.use_document_fonts", 0);
/* do not check spelling as you type */
user_pref("layout.spellcheckDefault", 0);
/* do not show other shortcuts in url bar */
user_pref("browser.urlbar.shortcuts.bookmarks", false);
user_pref("browser.urlbar.shortcuts.history", false);
user_pref("browser.urlbar.shortcuts.tabs", false);
/* dont show alerts about passwords */
user_pref("signon.management.page.breach-alerts.enabled", false);
/* block audio and video by default */
